                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 dark:text-gray-300 text-gray-700">{{ $log->is_current_device ? __('Yes') : __('No') }}</td>
                            <td class="px-4 py-2 dark:text-gray-300 text-gray-700">{{ $log->agent['is_desktop'] ? __('Yes') : __('No') }}</td>
